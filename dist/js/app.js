...
loadFrameworkAndHome:function(){
    ...
    cordova.plugins.diagnostic.isLocationAvailable(function(available){
                                                   ...
                                                   app.iPickView.alert("Please, active GPS and restart to correctly use the app","GPS disabled",function(){
                                                            app.getCurrentPosition(true);
                                                                       app.loadPrintHome();
                                                        });
...
loadPrintHome:function(){
    ...
    if (!app.bluethootEnabled){
        app.iPickView.alert("Please, active Bluetooth to use the app","Bluetooth is not enabled");
    }
...
initialize:function(){
    ...
    cordova.plugins.diagnostic.isBluetoothAvailable(app.successCallbackBluetooth, app.errorCallbackBluetooth);
				// app.getMyDevice(app.getMyLists,app.loadFrameworkAndHome);
...
successCallbackBluetooth: function(){
			 app.getMyDevice(app.getMyLists,app.loadFrameworkAndHome);
},
errorCallbackBluetooth:function(){
			 app.bluethootEnabled = false;
			 app.getMyDevice(app.getMyLists,app.loadFrameworkAndHome);
},
...
updateConnectionDeviceFound:function(device){
			 navigator.geolocation.getCurrentPosition(
                                                      ...
                                                      app.db.transaction(function(tx){
                                                                         tx.executeSql('update devices set last_seen = ? where id = ?', [device.lastSeen,id], 
                                                                                       function(tx, results){  
                                                                                       }, app.errorCB);  
                                                                         }); 
